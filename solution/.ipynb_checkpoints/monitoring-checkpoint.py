...
MODEL_VERSION = "0.1"
def get_latest_train_data(prefix, country, model_version):
    """
    Loading latest training data
    """
    model_name = re.sub("\.","_",str(model_version))
    data_file = os.path.join(MODEL_DIR, '{}-{}-{}-train.pickle'.format(prefix, country, model_name))
...
if __name__ == "__main__":
    ...
    data = get_latest_train_data('sl', 'united_kingdom', MODEL_VERSION)
    y = data['y']
    X = data['X']
    #print(X)
    #print(y)
